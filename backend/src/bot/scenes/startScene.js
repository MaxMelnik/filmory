...
scene.on(message('text'), async (ctx) => {
    ...
    const response = await ai.models.generateContent({
        ...
        contents: `Дай 5 варіантів фільмів схожих на ${sourceFilmTitle}. Не повторюй текст запиту і не додавай форматування. Відповідь - простий нумерований список: Назва фільму | короткий опис одним реченням`,
    });
    console.log('-------------------------------------------------------------------------------');
